...
- NOT A SUBMITTED ASSIGNMENT
- This is a reasonable self-test to make sure you understand how to use service calls in React before adding them in your final project
